...
```python
# Emare Ulak — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emareulak.view',      # Görüntüleme
    'emareulak.create',    # Oluşturma
    'emareulak.edit',      # Düzenleme
    'emareulak.delete',    # Silme
    'emareulak.manage',    # Tam yönetim
    # Admin
    'emareulak.admin',     # Admin panele erişim
    'emareulak.users',     # Kullanıcı yönetimi
    'emareulak.settings',  # Ayar yönetimi
]
```
...
```python
# emareulak/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emareulak.view', 'emareulak.create',
        'emareulak.edit', 'emareulak.delete',
        'emareulak.manage', 'emareulak.users',
        'emareulak.settings', 'emareulak.admin',
    },
    'operator': {
        'emareulak.view', 'emareulak.create',
        'emareulak.edit',
...
| Proje Admini | admin@emareulak.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emareulak.emare.dev | super_admin | Machine-to-machine |
